...
export const DELETE_SURVEY_PARTICIPANT_REQUEST =
  'DELETE_SURVEY_PARTICIPANT_REQUEST';
export const DELETE_SURVEY_PARTICIPANT_SUCCESS =
  'DELETE_SURVEY_PARTICIPANT_SUCCESS';
export const DELETE_SURVEY_PARTICIPANT_FAILED =
  'DELETE_SURVEY_PARTICIPANT_FAILED';
export const ICS_FILE_REQUEST = 'ICS_FILE_REQUEST';
export const ICS_FILE_SUCCESS = 'ICS_FILE_SUCCESS';
export const ICS_FILE_FAILED = 'ICS_FILE_FAILED';

export const DELETE_SURVEY_DATE_REQUEST = 'DELETE_SURVEY_DATE_REQUEST';
export const DELETE_SURVEY_DATE_SUCCESS = 'DELETE_SURVEY_DATE_SUCCESS';
export const DELETE_SURVEY_DATE_FAILED = 'DELETE_SURVEY_DATE_FAILED';

export const SURVEY_EMAIL_CONTENT_REQUEST = 'SURVEY_EMAIL_CONTENT_REQUEST';
export const SURVEY_EMAIL_CONTENT_SUCCESS = 'SURVEY_EMAIL_CONTENT_SUCCESS';
export const SURVEY_EMAIL_CONTENT_FAILED = 'SURVEY_EMAIL_CONTENT_FAILED';

export const SURVEY_EMAIL_DOMAIN_REQUEST = 'SURVEY_EMAIL_DOMAIN_REQUEST';
export const SURVEY_EMAIL_DOMAIN_SUCCESS = 'SURVEY_EMAIL_DOMAIN_SUCCESS';
export const SURVEY_EMAIL_DOMAIN_FAILED = 'SURVEY_EMAIL_DOMAIN_FAILED';

export const SET_SURVEY_EMAIL_CONTENT_REQUEST =
  'SET_SURVEY_EMAIL_CONTENT_REQUEST';
export const SET_SURVEY_EMAIL_CONTENT_SUCCESS =
  'SET_SURVEY_EMAIL_CONTENT_SUCCESS';
export const SET_SURVEY_EMAIL_CONTENT_FAILED =
  'SET_SURVEY_EMAIL_CONTENT_FAILED';
...
export const requestDeleteSurveyParticipant = payload => ({
  type: DELETE_SURVEY_PARTICIPANT_REQUEST,
  payload,
});

export const deleteSurveyParticipantSuccess = payload => ({
  type: DELETE_SURVEY_PARTICIPANT_SUCCESS,
  payload,
});

export const deleteSurveyParticipantFailed = error => ({
  type: DELETE_SURVEY_PARTICIPANT_FAILED,
  payload: error,
});

export const requestIcsFile = payload => {
  return {
    type: ICS_FILE_REQUEST,
    payload,
  };
};

export const icsFileSuccess = payload => ({
  type: ICS_FILE_SUCCESS,
  payload,
});

export const icsFileFailed = error => ({
  type: ICS_FILE_FAILED,
  payload: error,
});
export const requestDeleteSurveyDate = payload => ({
  type: DELETE_SURVEY_DATE_REQUEST,
  payload,
});

export const deleteSurveyDateSuccess = payload => ({
  type: DELETE_SURVEY_DATE_SUCCESS,
  payload,
});

export const deleteSurveyDateFailed = error => ({
  type: DELETE_SURVEY_DATE_FAILED,
  payload: error,
});

export const requestSurveyEmailContent = payload => ({
  type: SURVEY_EMAIL_CONTENT_REQUEST,
  payload,
});

export const surveyEmailContentSuccess = payload => ({
  type: SURVEY_EMAIL_CONTENT_SUCCESS,
  payload,
});

export const surveyEmailContentFailed = error => ({
  type: SURVEY_EMAIL_CONTENT_FAILED,
  payload: error,
});
export const requestSetSurveyEmailContent = payload => ({
  type: SET_SURVEY_EMAIL_CONTENT_REQUEST,
  payload,
});

export const setSurveyEmailContentSuccess = payload => ({
  type: SET_SURVEY_EMAIL_CONTENT_SUCCESS,
  payload,
});

export const setSurveyEmailContentFailed = error => ({
  type: SET_SURVEY_EMAIL_CONTENT_FAILED,
  payload: error,
});

export const requestEmaildomain = payload => ({
  type: SURVEY_EMAIL_DOMAIN_REQUEST,
  payload,
});

export const setEmailDomainSuccess = payload => ({
  type: SURVEY_EMAIL_DOMAIN_SUCCESS,
  payload,
});

export const setEmailDomainFailed = error => ({
  type: SURVEY_EMAIL_DOMAIN_FAILED,
  payload: error,
});
