      ...
      >
        {({
          ...
          <>
            <div
              role="region"
              aria-label="Image Transformation Region"
            ...
            <div className="dashboard-footer__right">
              ...
              <Button
                variant="white"
                aria-label="Zoom-Out_host"
                className="btn-icon ms-3"
                onClick={e => {
                  handleIncrease();
                  setTimeout(() => {
                    setTransformScale(zoomLevel - 0.2);
...
Container.propTypes = {
  ...
  setTransformScale: PropTypes.func,
