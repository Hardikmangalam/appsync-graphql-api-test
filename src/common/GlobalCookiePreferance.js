...
const GlobalCookiePreferance = () => {
  ...
  return (
    <>
      ...
      >
        <Image src={CookieIcon} alt="cookie preferance" />
      </button> */}
...
export default GlobalCookiePreferance;
